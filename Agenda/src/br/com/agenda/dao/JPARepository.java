...
/**
 * Classe JPA que implementa a interface Repository para as negociações com a
 * base de dados.
 *
 ...
 */
public class JPARepository< T, PK extends Serializable> implements Repository<T, PK> {
    ...
    public static Connection getDataConnection() throws SQLException {
        return DriverManager.getConnection("jdbc:postgresql://localhost:5432/agenda_db", "postgres", "postgres");
    }
